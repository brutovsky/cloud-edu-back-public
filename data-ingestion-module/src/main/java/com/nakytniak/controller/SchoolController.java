...
public class SchoolController {
    ...
    public ResponseEntity<Void> registerNewSchool(final JwtUser jwtUser,
            final SchoolRegistrationInfo schoolRegistrationInfo) {
    ...
    public ResponseEntity<Message> requestNewSchool(final NewSchoolRegistrationInfo newSchoolRegistrationInfo) {
